...
with history(year, legacy_loan_id, member_name, from_date, principal, monthly_interest, interest_text, renewal_or_return, status, total_paid, is_interest_free) as (
  values
    ('2021-22','SMA-21-001','Example Member','2021-06-01'::date,30000::numeric,450::numeric,'450','Jul-21','Clear',450::numeric,false),
    ('2022-23','SMA-22-001','Example Member','2022-10-01'::date,50000::numeric,750::numeric,'750','Nov-22','Active',2250::numeric,false),
    ('2023-24','SMA-24-001','Santosh','2024-04-01'::date,30000::numeric,450::numeric,'450','May-24','Clear',450::numeric,false),
    ('2023-24','SMA-24-002','Pratap','2024-04-01'::date,140000::numeric,2100::numeric,'2100','Jun-25','Active',14700::numeric,false),
    ('2023-24','SMA-24-003','Manjunath','2024-04-01'::date,100000::numeric,1500::numeric,'1500','Dec-24','Active',10500::numeric,false),
    ('2023-24','SMA-24-004','Pratap','2024-04-01'::date,50000::numeric,750::numeric,'750','Dec-24','Active',5250::numeric,false),
    ('2023-24','SMA-24-005','Pradeep','2024-04-01'::date,100000::numeric,1500::numeric,'1500','Mar-25','Active',10500::numeric,false),
    ('2023-24','SMA-24-006','Santosh','2024-04-01'::date,100000::numeric,1500::numeric,'1500','Apr-25','Active',10500::numeric,false),
    ('2023-24','SMA-24-007','Pratap','2024-05-01'::date,60000::numeric,900::numeric,'900','May-25','Active',5400::numeric,false),
    ('2023-24','SMA-24-008','Pradeep','2024-11-01'::date,100000::numeric,1500::numeric,'1500','Nov-25','Active',0::numeric,false),
    ('2024-25','SMA-24-003','Manjunath','2024-12-01'::date,100000::numeric,1500::numeric,'1500','Dec-24','Clear',1500::numeric,false),
    ('2024-25','SMA-24-006','Santosh','2024-12-01'::date,100000::numeric,1500::numeric,'1500','Apr-25','Clear',7500::numeric,false),
    ('2024-25','SMA-24-002','Pratap','2024-12-01'::date,140000::numeric,2100::numeric,'2100','Jun-26','Active',0::numeric,false),
    ('2024-25','SMA-24-004','Pratap','2024-12-01'::date,50000::numeric,750::numeric,'750','Dec-25','Active',0::numeric,false),
    ('2024-25','SMA-24-005','Pradeep','2024-12-01'::date,100000::numeric,1500::numeric,'1500','Mar-26','Active',0::numeric,false),
    ('2024-25','SMA-24-007','Pratap','2024-12-01'::date,60000::numeric,900::numeric,'900','May-26','Active',0::numeric,false),
    ('2024-25','SMA-24-008','Pradeep','2024-11-01'::date,100000::numeric,1500::numeric,'1500','Nov-25','Active',0::numeric,false),
    ('2024-25','SMA-25-001','Sarpabhushana','2024-12-01'::date,30000::numeric,450::numeric,'450','Dec-25','Active',0::numeric,false),
    ('2024-25','SMA-25-002','Santosh','2024-12-01'::date,40000::numeric,600::numeric,'600','Jul-25','Clear',4800::numeric,false),
    ('2024-25','SMA-25-003','Praveen','2025-02-01'::date,70000::numeric,1050::numeric,'1050','May-26','Clear',3150::numeric,false),
    ('2024-25','SMA-25-004','Manjunath','2025-04-01'::date,100000::numeric,1500::numeric,'1500','Jul-25','Clear',4500::numeric,false),
    ('2024-25','SMA-25-005','Manjunath','2025-06-01'::date,100000::numeric,1500::numeric,'1500','Jun-26','Active',0::numeric,false),
    ('2024-25','SMA-25-006','Praveen','2025-07-01'::date,100000::numeric,1500::numeric,'1500','Jul-26','Active',0::numeric,false),
